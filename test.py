...
from aihwkit.simulator.configs.utils import (
    WeightNoiseType, WeightClipType, WeightModifierType, MappingParameter)
from aihwkit.inference import PCMLikeNoiseModel, RRAMLikeNoiseModel, GlobalDriftCompensation
...
mapping = MappingParameter(digital_bias=False,
                           max_input_size=512,
                           max_output_size=512)
...
rpu_config.forward.w_noise_type = WeightNoiseType.RRAM_READ
...
rpu_config.noise_model = RRAMLikeNoiseModel(g_max=200.0, g_min=66.0)
