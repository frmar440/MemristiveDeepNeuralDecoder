...
# if not USE_HWA_TRAINING:
#     trained_model = convert_to_analog(trained_model, rpu_config)

time = datetime.now()
# save model
torch.save(model.state_dict(),
           f'mdnd/saves/{model.id}-{time}.pth')
# save training parameters
with open(f'mdnd/saves/{model.id}-{time}.json', 'w') as file:
