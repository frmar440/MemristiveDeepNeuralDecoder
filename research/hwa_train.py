...
from aihwkit.simulator.configs.utils import MappingParameter, WeightClipParameter, WeightClipType, WeightModifierParameter
...
rpu_config.noise_model = RRAMLikeNoiseModel(g_max=200.0, g_min=66.0, prog_noise_scale=1.) # the model described
rpu_config.clip = WeightClipParameter(sigma=2.5,
                                      type=WeightClipType.LAYER_GAUSSIAN)
rpu_config.modifier = WeightModifierParameter(pdrop=0.0)
